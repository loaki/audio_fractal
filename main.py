...
if __name__ == "__main__":
	...
	parser.add_argument("-cs", "--config_speaker", action="store_true", help="Configure default speaker")
	...
	# config_speaker(config)
	# record_sound(speaker_name=config["DEFAULT"]["micro"])